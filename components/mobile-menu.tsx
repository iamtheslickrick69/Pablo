          ...
          <nav className="flex flex-col space-y-6 container mx-auto">
            {menuItems.map((item) => (
              <Link
                ...
                className="text-xl font-mono uppercase transition-colors ease-out duration-150 py-2 text-foreground/60 hover:text-foreground/100"
              >
                {item.name}
              </Link>
            ))}
            ...
            <div className="mt-6">
              <Link
                href="tel:8017063783"
                onClick={handleLinkClick}
                className="inline-block text-xl font-mono uppercase transition-colors ease-out duration-150 py-2 text-primary hover:text-primary/80"
              >
                (801) 706-3783
              </Link>
            </div>
