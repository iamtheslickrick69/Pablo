      ...
      <div className="container">
        <div className="flex items-center justify-between py-3">
          ...
          <div className="flex items-center max-lg:hidden">
            <a
              href="tel:8017063783"
              className="group flex items-center gap-2 px-6 py-2.5 bg-white/10 hover:bg-white/20 backdrop-blur-xl border border-white/20 hover:border-white/30 transition-all duration-300 shadow-[0_4px_16px_rgba(0,0,0,0.2)]"
